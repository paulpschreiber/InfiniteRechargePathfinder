...
public class PathOdometryCommand extends CommandBase {
  ...
  public void initialize() {
    isFirstExecute = true;
    driveSubsystem.startPathOdometry();
  ...
  public void execute() {
    ...
    driveSubsystem.updatePathOdometry(timeElapsed);
  }
